...
this.onload = (event) => {
    ...
    if (form.length > 0) {
        form.addEventListener('submit', function (e) {
            ...
            console.log(((window.document.body.clientHeight - Math.abs(Math.min(...heights)) - window.innerHeight) - 350));
            console.log('body client height:', window.document.body.clientHeight);
            console.log('min height:', Math.abs(Math.min(...heights)));
